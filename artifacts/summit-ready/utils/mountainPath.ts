...
// All 27 segments derived from the master-route.svg path
const SEGS: SegFn[] = [
  ...
  t => cb(t, {x:229.5,y:125}, {x:232.5,y:123.5},    {x:235.5,y:121},     {x:236,y:117.5}),
  t => cb(t, {x:236,y:117.5}, {x:236.4,y:114.7},    {x:238.833,y:111.334},{x:240,y:110}),
  t => ln(t, {x:240,y:110},   {x:248,y:110}),
  t => cb(t, {x:248,y:110},   {x:252,y:111.667},    {x:260.5,y:114.5},   {x:262.5,y:112.5}),
  t => cb(t, {x:262.5,y:112.5},{x:265,y:110},        {x:272.5,y:104},     {x:274,y:100.5}),
  t => cb(t, {x:274,y:100.5}, {x:275.5,y:97},        {x:278.5,y:91},      {x:282.5,y:89.5}),
  t => cb(t, {x:282.5,y:89.5},{x:286.5,y:88},        {x:297,y:79},        {x:299,y:77.5}),
  t => cb(t, {x:299,y:77.5},  {x:301,y:76},          {x:307,y:62.5},      {x:310.5,y:60.5}),
  t => cb(t, {x:310.5,y:60.5},{x:314,y:58.5},        {x:323,y:56.5},      {x:325,y:53.5}),
  t => cb(t, {x:325,y:53.5},  {x:327,y:50.5},        {x:341.5,y:31.5},    {x:343,y:29}),
  t => cb(t, {x:343,y:29},    {x:344.2,y:27},        {x:350,y:16.3337},   {x:357.5,y:2}),
];

// ── Build arc-length table (300 steps per segment ≈ 8 100 raw points) ────────
