          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {GUIDES.map((guide) => (
                <div
                  key={guide.title}
                  className={`bg-white/3 border border-white/8 rounded-2xl p-6 flex flex-col gap-4 hover:border-white/15 transition-all duration-200 ${!guide.available ? "opacity-70" : ""}`}
                >
