          ...
          <div className="container mx-auto px-6 max-w-3xl">
            ...
            <section className="mb-8 bg-white/3 border border-white/8 rounded-2xl p-5 flex flex-col sm:flex-row items-center gap-5">
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">Answer 17 questions and get an instant result — including what to work on and how long you need to prepare for Everest Base Camp.</p>
              </div>
              <Link to="/readiness-check?mountain=everest-base-camp" className="shrink-0">
